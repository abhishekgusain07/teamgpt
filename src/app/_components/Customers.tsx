    ...
    return (
        <div className="bg-gray-100 p-8">
            <div className="flex flex-col py-2.5 justify-center basis-auto flex-shrink flex-grow self-auto gap-[20px] items-normal mx-auto h-full w-full max-w-[1140px] text-center">
                ...
                <Spacer height={25}/>
                <div className="flex flex-col md:flex-row  gap-[30px] md:gap-[4%] basis-auto justify-evenly flex-shrink p-[10px] mx-auto animate-fadeInUp">
                    {companies.map((_,idx) => (
                        <div key={idx} className="flex flex-row items-center max-w-full smb-[20px] text-center">
